...
module_u_blueprint = Blueprint('module_u', __name__,url_prefix='/module_u')

@module_u_blueprint.route('/')
def module_u():
    return render_template('module_u.html')

@module_u_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
