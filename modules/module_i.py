...
module_i_blueprint = Blueprint('module_i', __name__,url_prefix='/module_i')

@module_i_blueprint.route('/')
def module_i():
    return render_template('module_i.html')

@module_i_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
