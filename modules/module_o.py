...
module_o_blueprint = Blueprint('module_o', __name__,url_prefix='/module_o')

@module_o_blueprint.route('/')
def module_o():
    return render_template('module_o.html')

@module_o_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
